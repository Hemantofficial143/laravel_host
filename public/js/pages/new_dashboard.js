...
function toastFun(name){
    ...
    var title = "<span>Welcome!</span> <h5 class='text-white'>"+name+"</h5>";
...
// -=========================end main chat js========================
    ...
    // =================top 4 sections countup js==================]
        ...
        new CountUp("visitors_count", 0, 100, 0, 2.5, options).start();
        new CountUp("revenue_count", 0, 1200, 0, 2.5, options).start();
        new CountUp("subscribers_count", 0, 100, 0, 2.5, options).start();
