...
<i class="fa fa-eye fa-stack-1x fa-inverse text-success visit_icon"></i>
                                    ...
                                    <div class="col-lg-7 col-7 icon_padd_right">
                                        <div class="float-right cards_content">
                                            <span class="number_val">{{ $admin_count }}</span><i
                                                    class="fa fa-long-arrow-up fa-2x"></i>
                                            <br/>
                                            <span class="card_description">Admins</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<i class="fa fa-users  fa-stack-1x fa-inverse text-mint sub"></i>
                                    ...
                                    <div class="col-lg-7 col-7 icon_padd_right">
                                        <div class="float-right cards_content">
                                            <span class="number_val">{{ $user_count }}</span><i
                        ...
                        <div class="card-body">
                            <div class="row margin_align">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            @if ($temp_data->weather[0]->main == "Mist")
                                                <img width="250" height="200" src="{{ url('storage/weather/mist.gif') }}" alt="Mist">
                                            @elseif($temp_data->weather[0]->main == "Clear")
                                                <img width="250" height="200" src="{{ url('storage/weather/clear.gif') }}" alt="Clear">
                                            @elseif($temp_data->weather[0]->main == "Clouds")
                                                <img width="250" height="200" src="{{ url('storage/weather/cloud.gif') }}" alt="Cloudy">
                                            @elseif($temp_data->weather[0]->main == "Rain")
                                                <img width="250" height="200" src="{{ url('storage/weather/rain.gif') }}" alt="Rain">
                                            @elseif($temp_data->weather[0]->main == "Haze")
                                                <img width="250" height="200" src="{{ url('storage/weather/mist.gif') }}" alt="Haze">
                                            @endif
                                           
                                        </div>
                                        <div class="col-6">
                                            <div class="weather-value">
<span class=" text-white"><span class="degree">{{ $temp }}&deg;</span>
</span>
                                            </div>
                                            <div class="weather_location">
                                                <span class="text-white"><i class="fa fa-map-marker"></i> {{ $location_data->cityName }}, </span>
                                                <span class="text-white">{{ $location_data->countryName }} </span>    
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <table>
                                            <tr>
                                                <th class="text-white p-2">Latitude</th>
                                                <th class="text-white p-2">:</th>
                                                <th class="text-white p-2">{{ $temp_data->coord->lat }}</th>
                                                <th class="text-white p-2">Longitude</th>
                                                <th class="text-white p-2">:</th>
                                                <th class="text-white p-2">{{ $temp_data->coord->lon }}</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                            </tr>
...
@section('footer_scripts')
    ...
    <script type="text/javascript"
            src="{{asset('vendors/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    ...
    <script>
        $( document ).ready(function() {
            var name = "{{ Auth::guard('admin')->user()->name }}";
            toastFun(name);
        });
    </script>
@stop
