                                            ...
                                            <div class="col-12 col-lg-6 text-center text-lg-left">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new img-thumbnail text-center">
                                                        <img src="{{asset('img/admin2.jpg')}}" data-src="img/admin2.jpg" alt="not found"></div>
                                        ...
                                        <div class="form-group row m-t-25">
                                            ...
                                            <div class="col-12 col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ $user->name }}" name="firstName" id="u-name" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="phone" name="cell" class="form-control" value="{{ $user->mobile }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-xl-6 col-lg-8">
                                                <div>
                                                    <label class="custom-control custom-checkbox">
                                                        @if ($user->status == 0)
                                                            <input id="checkbox1" type="checkbox" name="activate" class="custom-control-input" >    
                                                        @else
