                    ...
                    <ul class="nav navbar-nav flex-row top_menubar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ url('/admin/users') }}">
                                <i class="fa fa fa-user"></i> <span class="quick_text">Users</span>
                            </a>
                        </li>
                        {{-- <li class="nav-item">
                    ...
                    <div class="btn-group">
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn text-white" data-toggle="dropdown">
                                <!--<img src="{{url('/storage/images/admins/'.Auth::guard('admin')->user()->profile_img)}}" class="admin_img2 rounded-circle avatar-img" alt="avatar"> <strong>{{ Auth::guard('admin')->user()->name }}</strong>-->
                                <img src="{{'https://ui-avatars.com/api/?name='.Auth::guard('admin')->user()->name.'rounded=true'}}" class="admin_img2 rounded-circle avatar-img" alt="avatar"> <strong>{{ Auth::guard('admin')->user()->name }}</strong>
                            ...
                            <div class="dropdown-menu admire_admin">
                                ...
                                <a class="dropdown-item" href="lockscreen"><i class="fa fa-lock"></i>
                                    Lock Screen</a>
                                <a class="dropdown-item" href="{{ route('admin.login.logout') }}"><i class="fa fa-sign-out"></i>
                                    Log Out</a>
                            </div>
                        </div>
                    </div>
        ...
        <div id="left" class="fixed">
            <div class="menu_scroll left_scrolled">
                    ...
                    <div class="user-wrapper">
                        <a class="user-link" href="">
                            ...
                            <img class="media-object img-thumbnail user-img rounded-circle admin_img3" alt="User Picture"
                                 src="{{'https://ui-avatars.com/api/?name='.Auth::guard('admin')->user()->name.'rounded=true'}}">
                            <p class="text-white user-info">Welcome<br />{{ Auth::guard('admin')->user()->name }}</p></a>
                ...
                <ul id="menu" class="bg-blue dker">
                    ...
                    {{-- Import Product --}}
                    <li {!! (Request::is('/admin/products/import')? 'class="active"':"") !!}>
                        <a href="{{ url('/admin/products/import') }} ">
                            <i class="fa fa-file-import"></i>
                            <span class="link-title menu_hide">&nbsp;&nbsp;Import Products </span>
                        </a>
                    </li>
                    ...
                    {{-- <li {!! (Request::is('index1')? 'cl ass="active"':"") !!}>
