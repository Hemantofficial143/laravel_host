            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title d-inline text-white">Crud Generator</h5>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-danger text-white">
                        <h5 class="card-title d-inline text-white">Rollback</h5>
                        <span class="float-right">
                            <i class="fa fa-chevron-up clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
                        </span>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h5 class="card-title d-inline text-white">Generate CRUD From Schema</h5>
                        <span class="float-right">
                            <i class="fa fa-chevron-up clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
                        </span>
